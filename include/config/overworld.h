...
#define OW_FLAG_NO_ENCOUNTER        FLAG_UNUSED_0x2B9  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FLAG_UNUSED_0x2BA  // If this flag is set, trainers will not battle the player unless they're talked to.
